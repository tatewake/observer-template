{
    ...
    'targets': [{
		'target_name':	'WindowEventExample',
		'product_name':	'WindowEventExample',
		'type':			'executable',
		'mac_bundle':	1,

		'sources': [
			'../../examples/WindowEvent/App.cc',
			'../../examples/WindowEvent/App.h',
			'../../examples/WindowEvent/Window.cc',
			'../../examples/WindowEvent/Window.h',
			'../../examples/WindowEvent/WindowEvent.h',
			'../../examples/WindowEvent/main.cc',
			'../../tObserver.h',
		],	# sources
